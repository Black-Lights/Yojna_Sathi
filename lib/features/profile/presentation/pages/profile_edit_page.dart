...
class _ProfileEditPageState extends State<ProfileEditPage> {
  ...
  void _handleSubmit(UserProfile currentProfile) async {
    if (_formKey.currentState!.validate()) {
      ...
      final updatedProfile = currentProfile.copyWith(
        ...
        location: UserLocation(
          ...
          village: currentProfile.location.village,
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () => _handleSubmit(state.profile),
